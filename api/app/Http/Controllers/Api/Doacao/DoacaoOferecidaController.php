...
class DoacaoOferecidaController extends Controller
{
    public function __construct(private DoacaoService $doacaoService) {}

    public function index () {
        try {
            $doacoes = $this->doacaoService->listar(['perfil_doacao_id' => PerfilDoacao::ID_OFERECIDA]);
    ...
    public function doacoesMapa (Request $request) {
        try {
            $dados = $request->all();
            $dados['perfil'] = PerfilDoacao::ID_OFERECIDA;
    ...
    public function store(Request $request)
    {
        ...
        try {
            $this->doacaoService->criar($dados, PerfilDoacao::ID_OFERECIDA);
